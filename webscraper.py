...
while(restart):
    ...
    # ===============================
    Text_restart = Name("Press 'R' to refresh")
    Pname(Text_restart, 105, 50)
    ...
    Text00, Text10, Text20, Text30, Text40, Text50, Text60, Text70, Text80 = Name(str("%.2f" % Net_Worth)), Name(
        str(P_engie)), Name(str(P_fleury)), Name(str(P_ambev)), Name(str(P_itausa)), Name(str(P_Magalu)), Name(
        str(P_Enbr)), Name(str("%.2f" % Pre)), Name(str("%.2f" % pre5))
